...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n--- TESTANDO O STRATEGY (LIVRO) ---");
        EstrategiaPublicacao estrategiaLivro = new PublicacaoLivro();
        autor.setEstrategia(estrategiaLivro);
        System.out.print(autor.getNome() + " está: ");
        autor.publicar(); 
